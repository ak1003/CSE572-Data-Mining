...
height,width=mealPrincipalComponentDataFrame.shape
df_1 = pd.DataFrame(np.ones((height, 1)))
...
height,width=noMealPrincipalComponentDataFrame.shape
df_0 = pd.DataFrame(np.zeros((height, 1)))
...
finalMealNoMealLabel = pd.concat([df_1, df_0], axis=0)
# columns=['fft1','fft2','fft3','fft4','velocity1','velocity2','velocity3','velocity4',
#         'rolling1','rolling2','rolling3','rolling4',
#         'dwt1','dwt2','dwt3','dwt4']
finalPCADataFrame=s.applyPCA(finalMealNoMealDataFrame,3)
print(finalMealNoMealLabel.shape)
print(finalPCADataFrame)
finalPCADataFrame['Label']=finalMealNoMealLabel[0].values
...
finalPCADataFrame.to_csv("finalMealNoMeal.csv")
